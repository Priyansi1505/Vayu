  ...
  {t("footerDesc")}
            ...
            <div className="flex gap-3">
              {[Facebook, Twitter, Instagram, Linkedin, Github].map((Icon, index) => (
                <a
                  key={index}
                  href="#"
                  className="w-9 h-9 rounded-full bg-white/20 border border-white/30 flex items-center justify-center hover:bg-white/30 transition-all"
                >
                  <Icon className="w-4 h-4 text-[#333333] dark:text-white" />
                </a>
              ))}
            </div>
          </div>
          ...
          <div>
           <h3 className="font-semibold mb-4 text-[#333333] dark:text-white">{t("quickLinks")}</h3>
            <ul className="space-y-2 text-sm text-[#333333]/70 dark:text-white/70">
              ...
              <li><a href="#" className="hover:text-[#A5C7E9] transition-colors">{t("resources")}</a></li>
         ...
         {/* Resources */}
          ...
          <div>
           <h3 className="font-semibold mb-4 text-[#333333] dark:text-white">{t("contactUs")}</h3>
            <ul className="space-y-3 text-sm text-[#333333]/70 dark:text-white/70 mb-6">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@vayu.com" className="hover:text-[#A5C7E9] transition-colors">
                  info@vayu.com
                </a>
              </li>
              <li className="flex items-center gap-2">
           ...
           <h4 className="font-semibold mb-2 text-sm text-[#333333] dark:text-white">{t("resources")}</h4>
